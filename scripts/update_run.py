...
APPEND_MAP = {
    ...
    "first_principle": "gates.first_principles",
    "assumption": "gates.assumptions",
    "adversarial_finding": "gates.adversarial_findings",
    "edge_case": "gates.edge_cases",
    "rejected_option": "gates.rejected_options",
